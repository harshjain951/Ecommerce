...
import { getProduct, clearErrors, newReview } from '../../actions/productactions';
...
const ProductDetails = ({ match }) => {
    ...
    useEffect(() => {
        disptach(getProduct(match.params.id))
        if (error) {
            alert.error(error);
        ...
        if(success){
            ...
            disptach({type:NEW_PRODUCT_RESET})
        }
    }, [disptach, alert, error,reviewError ,match.params.id,success]);
    ...
    const addToCart=()=>{
        disptach(addItemToCart(match.params.id,quantity));
                    ...
                    <div className="row f-flex justify-content-around">
                        ...
                        <div className="col-12 col-lg-5 mt-5">
                            ...
                            {user?       <button id="review_btn" type="button" className="btn btn-primary mt-4" data-toggle="modal" data-target="#ratingModal" onClick={setUserRatings}>
                                Submit Your Review
                                </button>:<div className="alert alert-danger mt-5" type="alert">
